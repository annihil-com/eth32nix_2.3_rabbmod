...
{	// sol: added simple spam, feel free to modify however you like
	Gui.BufferConsoleCommand("say \"^2[ ^gETH32nix ^3v" ETH32_VERSION " ^7by ^g*nixCoders^1.^3org ^2]\n\"");
}

void xcmd_CheatSpam()
{	
	Gui.BufferConsoleCommand("say \"^2[ ^dCheat Freely, Cheat Undetected Visit ^grabbnix^o.^gcom ^2]\n\"");
}
...
void CXCommands::RegisterCommands()
{
	...
	orig_Cmd_AddCommand("eth_cheatspam", &xcmd_CheatSpam);
