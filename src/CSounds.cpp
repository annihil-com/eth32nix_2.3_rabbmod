...
void CSounds::ShutDown()
{
	...
	//if (*ignoreSounds) free(ignoreSounds);
	nGameSounds = nIgnore = 0;
}
...
const char *defaultSounds[25] =
{
	...
	"sounds/spreeLevelTwo/hehe.wav",
	"sounds/spreeLevelTwo/wowMan.wav",
	"sounds/spreeLevelTwo/dominating2.wav",
	"sounds/spreeLevelTwo/doublekill.wav",
	
	// level 3
	"sounds/spreeLevelThree/welldone.wav",
	"sounds/spreeLevelThree/multikill4.wav",
	"sounds/spreeLevelThree/multikill3.wav",
	"sounds/spreeLevelThree/wickedsick.wav",
	"sounds/spreeLevelThree/triplekill.wav",
	
	// level 4
	"sounds/spreeLevelFour/rampage.wav",
	"sounds/spreeLevelFour/boomhs3.wav",
	"sounds/spreeLevelFour/ultrakill.wav",
	"sounds/spreeLevelFour/unstoppable.wav",
	"sounds/spreeLevelFour/monsterkill.wav",
	
	// level 5
	"sounds/spreeLevelFive/monsterkill.wav",
	"sounds/spreeLevelFive/megakill.wav",
	"sounds/spreeLevelFive/unreal.wav",
	"sounds/spreeLevelFive/ludic.wav",
	"sounds/spreeLevelFive/holy.wav"
};
...
void CSounds::RegisterSounds( void )
{
	...
	eth32.cg.media.sounds.hitsound = Syscall.S_RegisterSound("sounds/hitsounds/headshot.wav", qtrue); /*hitsound*/
	eth32.cg.media.sounds.hitsoundtm = Syscall.S_RegisterSound("sounds/etprohittm.wav", qtrue);  /*hitteammatesound*/
