...
void CGui::Init(void)
{
	...
	SetViewConfig(	GUI_IRCVIEW,		XK_F10,		0,		XK_Escape,		funcOpenIrcView	);
	SetViewConfig(	GUI_CLIENTVIEW,		XK_F11,		0,		XK_Escape,	NULL			);
	SetViewConfig(	GUI_USERVIEW,		XK_F12,		0,		XK_Escape,	NULL			);
	...
	winPicker->AddWindow("Aimbot Misc", CAT_AIMBOT);
	winPicker->AddWindow("Human Aim", CAT_HUMAN);
	winPicker->AddWindow("Humanaim", CAT_HUMAN);
//	winPicker->AddWindow("Weap Rendering", CAT_AIMBOT);
//	winPicker->AddWindow("Aimbot Master", CAT_AIMBOT);
	winPicker->AddWindow("Grenadebot", CAT_GRENADEBOT);
	winPicker->AddWindow("Custom Hitbox", CAT_AIMBOT);
//	winPicker->AddWindow("Misc Aim", CAT_AIMBOT);
...
void CGui::MouseWheelEvent(uint32 status)
{
/*
