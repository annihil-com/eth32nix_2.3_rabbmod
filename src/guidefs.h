...
/*	{
	...
	},
	{
		...
		WIN_STANDARD,			// type
		GUI_MENUVIEW,			// view
		395, 59, 200, 180,		// x, y, w, h
		7,				// num controls
		{
			// Type				Label		X	Y	W	H		Arg0 ... Arg4
			{ CTRL_CHECKBOX,	"Preshoot",		5,	5,	190,	8,		(int)&eth32.settings.preShoot },
			{ CTRL_CHECKBOX,	"Preaim",		5,	18,	190,	8,		(int)&eth32.settings.preAim },
			{ CTRL_CHECKBOX,	"Apply Target Prediction",	5,	31,	190,	8,		(int)&eth32.settings.predTargzor },
			{ CTRL_FLOATSLIDER,	"Preshoot Time",	5,	50,	190,	20,		SETFLOAT(0), SETFLOAT(300), (int)&eth32.settings.preShootTime },
			{ CTRL_FLOATSLIDER,	"Preaim Time",		5,	70,	190,	20,		SETFLOAT(0), SETFLOAT(1000), (int)&eth32.settings.preAimTime },
			{ CTRL_DROPBOX,		"Aimbot Mode", 		5, 	95,	190,	23,		0, AIMMODE_MAX-1, (int)&eth32.settings.aimMode, (int)aimModeText },
	...
	//humanshyt
	{
		...
		WIN_STANDARD,			// type
		GUI_MENUVIEW,			// view
		376, 49, 150, 45,		// x, y, w, h
		1,						// num controls
		{
			// Type				Label		X	Y	W	H		Arg0 ... Arg4
			{ CTRL_DROPBOX,		"Human Aim", 		5, 	5,	140,	23,		0, HUMAN_AIM_MAX-1, (int)&eth32.settings.humanAimMode, (int)humanAimTypeText },
		}
	},
	// HUMANAIM
	{
		...
		WIN_STANDARD,			// type
		GUI_MENUVIEW,			// view
		325, 60, 150, 270,		// x, y, w, h
		5,						// num controls
		{
			// Type				Label					X		Y		W		H		Arg0 ... Arg4
			{ CTRL_FLOATSLIDER,	"Humanaim Value",	5,		5,		140,	20,		SETFLOAT(0.0), SETFLOAT(1.0), (int)&eth32.settings.humanvalue },
			{ CTRL_FLOATSLIDER,	"Divmax",	5,		29,	140,	20,		SETFLOAT(0), SETFLOAT(10), (int)&eth32.settings.divmax },
			{ CTRL_FLOATSLIDER,	"Divmin",	5,		53,	140,	20,		SETFLOAT(0), SETFLOAT(10), (int)&eth32.settings.divmin },
			{ CTRL_FLOATSLIDER,	"Horizontal Speed",	5,		77,	140,	20,		SETFLOAT(0), SETFLOAT(1), (int)&eth32.settings.xspeed },
			{ CTRL_FLOATSLIDER,	"Vertical Speed",	5,		101,	140,	20,		SETFLOAT(0), SETFLOAT(1), (int)&eth32.settings.yspeed },
		}
	},
/*	{
		"Misc Aim",				// title
		...
		{
			// Type				Label		X	Y	W	H		Arg0 ... Arg4
			{ CTRL_DROPBOX,		"Aim Protect", 		5, 	5,	140,	23,		0, PROTECT_MAX-1, (int)&eth32.settings.aimprotect, (int)aimprotectText },
		}
	},*/	
};
