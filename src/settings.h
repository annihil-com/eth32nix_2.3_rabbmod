...
const static settingdef_t settingsDefs[] =
{
	...
	{ "champlayer",		"1",			SETTING_INT,		(void*)&eth32.settings.chamsPlayer,
		...
		CHAMS_OFF, MAX_CHAMS-1,
		{
			...
			{ (int)CHAMS_QUAD,		"quad" },
			{ (int)CHAMS_HACK,		"hack" },
			{ (int)CHAMS_KANKER,		"kanker" },
			{ (int)CHAMS_INVI,		"invi" },
			{ (int)CHAMS_SPARKLE,		"sparkle" },
	...
	{ "hitbox",			"1",			SETTING_INT,		(void*)&eth32.settings.hitboxType,
		...
		HITBOX_OFF, HITBOX_MAX-1,
		{
			...
			{ (int)HITBOX_ELITE1,	"elite1" },
			{ (int)HITBOX_ELITE2,	"elite2" },
			{ (int)HITBOX_ELITE3,	"elite3" },
			{ (int)HITBOX_ELITELEET,"eliteleet" },
			{ (int)HITBOX_LOVE,	"love" },
			{ (int)HITBOX_STEN,	"sten" },
			{ (int)HITBOX_STEN2,	"sten2" },
			{ (int)HITBOX_SIL,	"sil" },
			{ (int)HITBOX_SIL2,	"sil2" },
			{ (int)HITBOX_RABB,	"rabb" },
			{ (int)HITBOX_RABB2,	"rabb2" },
			{ (int)HITBOX_RABB3,	"rabb3" },
			{ (int)HITBOX_RABB4,	"rabb4" },
			{ (int)HITBOX_XH4X,	"xh4x" },
			{ (int)HITBOX_TEST1,	"test1" },
			{ (int)HITBOX_TEST2,	"test2" },
			{ (int)HITBOX_TEST3,	"test3" },
			{ (int)HITBOX_ORDER,	"order" },
			{ (int)HITBOX_HYPNO,	"hypno" },
			{ (int)HITBOX_EFU,	"efu" },
			{ (int)HITBOX_KILL,	"kill" },
			{ (int)HITBOX_REAPER,	"reaper" },
			{ (int)HITBOX_DARK,	"dark" },
	...
	{ "riflenadeZ",	"-6.5",				SETTING_FLOAT,	(void*)&eth32.settings.riflenadeZ,
	...
	{ "pk3name",		"eth32_v2_3.pk3",		SETTING_STRING,		(void*)eth32.settings.pk3file,
	...
	// custom hitbox
	{ "hb_stand",		"0 0 6",		SETTING_VEC3,		(void*)Aimbot.customHitbox.stand_offset,
		"set the hitbox center point for a standing player",
	},
	{ "hb_crouch",		"0 0 6",		SETTING_VEC3,		(void*)Aimbot.customHitbox.crouch_offset,
		"set the hitbox center point for a crouching player",
	},
	{ "hb_prone",		"0 0 6",		SETTING_VEC3,		(void*)Aimbot.customHitbox.prone_offset,
		"set the hitbox center point for a prone player",
	},
	{ "hb_run",		"0 0 6",		SETTING_VEC3,		(void*)Aimbot.customHitbox.stand_offset_moving,
		"set the hitbox center point for a running player",
	},
	{ "hb_crawl",		"0 0 6",		SETTING_VEC3,		(void*)Aimbot.customHitbox.crouch_offset_moving,
		"set the hitbox center point for a crawling player",
	},
	{ "hb_size",		"12 12 12",		SETTING_VEC3,		(void*)Aimbot.customHitbox.size,
	...
	{ "bannerfmt", "^2[ ^gETH32nix ^3v2.3 ^gby rabbit ^2] [N]  ^2-   ^7[n]&&^9hp: ^w[h] ^2| ^9am: ^w[a] ^2| ^9stats: ^o[k]^9/^o[d] ^9(^o[r]^9) ^2| ^9ss: ^2[s] | ^9spree: ^1[S]^9/^1[p] ^2| ^9limbo: ^7[L]", SETTING_STRING, (void*)eth32.settings.BannerFmt, 
		"banner format",
	},
